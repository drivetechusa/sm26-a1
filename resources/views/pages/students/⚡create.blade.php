...
class extends Component
{
    ...
    {
        $student = $this->form->store();

        session()->flash('success', 'Student created successfully.');

        return $this->redirect(route('students.show', $student->id), navigate: true);
    }
...
<div class="max-w-7xl mx-auto">
    <div class="mb-6">
        ...
        <flux:subheading>Enter student information to create a new student record.</flux:subheading>
    </div>
