...
<div class="max-w-7xl mx-auto">
    <div class="mb-6">
        <flux:heading size="xl">Create New Seminar</flux:heading>
        <flux:subheading>Enter seminar information below.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <flux:card>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <flux:field>
                    <flux:label>Sale Discount</flux:label>
