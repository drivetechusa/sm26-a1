...
trait PDF_forms
{
    ...
    public function account_statement(Student $student)
    {
        ...
        $pdf = new SafeMpdf(['default_font' => 'sans-serif', 'default_font_size' => '11', 'default_font_style' => 'b']);
    ...
    public function beginner_contract(Student $student, Seminar $seminar, $data = null): Mpdf
    {
        ...
        $pdf = new SafeMpdf(['default_font' => 'sans-serif', 'default_font_size' => '10', 'default_font_style' => 'b']);
        $pdf->setSourceFile(public_path('/templates/beginner_contract_reconfigured.pdf'));
        $template = $pdf->ImportPage(1);
        $pdf->useTemplate($template);
        $pdf->SetFont('freesans', 'bi', '9');
    ...
    {
        $pdf = new SafeMpdf(['default_font' => 'sans-serif', 'default_font_size' => '10']);
